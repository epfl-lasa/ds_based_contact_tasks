#ifndef __SURFACE_CUTTING_H__
#define __SURFACE_CUTTING_H__
...
class SurfaceCutting 
{
    ...
    ////////////////////////////
		...
		////////////////////
		int _attractorID;
    Eigen::Vector3f _xa[NB_ATTRACTORS];	 // Attractor position [m] (3x1)
    Eigen::MatrixXf _xa2;	 // Attractor position [m] (3x1)
    ...
    double _timeInit;
		...
		static SurfaceCutting* me;  // Pointer on the instance of the class
	...
	public:
		...
		// Class constructor
		SurfaceCutting(ros::NodeHandle &n, double frequency, std::string fileName, 
			             float targetVelocity, float targetForce);
